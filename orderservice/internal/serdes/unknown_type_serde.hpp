...
class UnknownTypeSerde final : public servicelib::serde::Serde<example::order_service::types::UnknownType> {
 public:
  ...
  example::order_service::types::UnknownType Deserialize(
    ...
    return userver::formats::json::FromString(text).As<example::order_service::types::UnknownType>();
  }
};
