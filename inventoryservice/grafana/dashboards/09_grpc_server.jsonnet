// Dashboard: gRPC Server (C++ / ServiceLib)
//
...
lib.dashboard(
  ...
  panels=[
    ...
    // ServiceLib publishes rolling percentiles rather than Prometheus histogram
    ...
    // lifecycle, restoring the bucket data absent from percentile-only gRPC
    // metrics.
