...
class InventoryFailureSerde final : public servicelib::serde::Serde<example::inventory_service::types::InventoryFailure> {
 public:
  ...
  example::inventory_service::types::InventoryFailure Deserialize(
    ...
    return userver::formats::json::FromString(text).As<example::inventory_service::types::InventoryFailure>();
  }
};
