...
class AnalyticsKeySerde final : public servicelib::serde::Serde<example::analytics_service::types::AnalyticsKey> {
 public:
  ...
  example::analytics_service::types::AnalyticsKey Deserialize(
    ...
    return userver::formats::json::FromString(text).As<example::analytics_service::types::AnalyticsKey>();
  }
};
